  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        <input className='bg-slate-200 p-3 rounded-lg' type='text' placeholder='Username' id='username' onChange={handleChange}/>
        <input className='bg-slate-200 p-3 rounded-lg' type='text' placeholder='Email' id='email' onChange={handleChange}/>
